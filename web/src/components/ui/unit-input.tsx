...
function UnitInput({ className, unit, ...props }: UnitInputProps) {
  return (
    <div
    ...
    >
      <Input
        {...props}
        className="h-auto border-0 bg-transparent p-0 font-bold tabular-nums shadow-none focus-visible:ring-0"
      />
      <span
