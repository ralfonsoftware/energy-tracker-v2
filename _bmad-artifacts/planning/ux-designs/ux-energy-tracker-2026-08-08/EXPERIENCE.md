...
→ Composition reference: [mockups/direction-green-eco.html](mockups/direction-green-eco.html) covers the Dashboard/Status card + Log Reading sheet as isolated component studies; [mockups/motion-demo.html](mockups/motion-demo.html) covers motion; [mockups/density-trend-history.html](mockups/density-trend-history.html) covers Trend History; [mockups/key-tariff-radar.html](mockups/key-tariff-radar.html) covers Tariff Radar (FR-10–FR-15, both entry paths); [mockups/key-smart-plug-import.html](mockups/key-smart-plug-import.html) covers Smart Plug Import (FR-4, FR-24). Still spine-only, no rendered mock: Log Event, Settings (beyond the Smart Plug Import sub-screen), and Onboarding/Household Setup.
