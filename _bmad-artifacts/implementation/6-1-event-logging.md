...
- 2026-09-19: AC #4's display-half decision item closed by Story 6.2, which shipped the Event read path. No other review item was open. Status in-progress -> done.
